...
REGISTRY = {
    ...
    'purchase_invoices': entity('采购发票与应付', DOMAINS[5], 'Purchase Invoice', 'name:发票|supplier_name:供应商|posting_date:记账日|due_date:到期日|status:状态|grand_total:金额|outstanding_amount:未付金额|currency:币种', date_field='posting_date', period='month', children=(ITEMS,), note='单据金额按各自币种显示，未付款不等于逾期。已取消单据的历史未付金额不代表当前欠款；查询当前应付须限定已提交单据，并核对有效会计与付款流水，不替代会计核对。'),
